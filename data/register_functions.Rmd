...
create_kyoki_net_from_df = function(remarks_df, path = NULL) {
  ...
  if(!is.null(path)){
    ...
    plot(simplified, vertex.size = 8, edge.arrow.size=0.8, edge.width=1, edge.curved=.1,  layout=layout_with_fr(simplified))
    legend("topleft",bty = "n",
       legend=attendees_fuseji,
       fill=pallet, border=NA, cex=2)
    dev.off()
  }
